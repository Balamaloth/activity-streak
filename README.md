# Daily Contribution (automated commits)
...
- COMMIT_EMAIL — a verified email address on your GitHub account (e.g., you@example.com)
...
- If your repo default branch is not `main`, update `HEAD:main` in the workflow to `HEAD:<your-branch>`.
